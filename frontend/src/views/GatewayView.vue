...
import { compactText, formatElapsed, formatNumber, includesSearch, normalizeStringList, normalizeStringList as normalizeModelList, shortFingerprint, supportedModelsPreview } from '../viewUtils'
...
const settingsForm = reactive<GatewaySettingsData>(createDefaultGatewaySettings())
...
const usageColumns = createUsageColumns({ usageRouteLabel })
...
<style scoped src="../styles/gateway-view.css"></style>
